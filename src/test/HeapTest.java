...
public class HeapTest extends TestCase {
    ...
    public void setupStage2(){
        ...
        date.set(1999, 5, 20);
        Patient patient1= new Patient("Paolo", date,"HOLA",2, StateEnum.INTERMEDIATE, AggravationEnum.OLD_AGE, 11000204);

        PatientNode patientNode1 = new PatientNode<Patient>(2, patient1, 11000204);

        date.set(2001, 3, 21);
        Patient patient2= new Patient("Juana", date, "HOLA",1, StateEnum.MILD, AggravationEnum.PREGNANT, 112453023);
    ...
    public void testHeapSearchObject_InsertPatient (){
        ...
        date.set(2002, 7, 23);
        Patient patientTest1 = new Patient("Roberta", date, "HOLA",2, StateEnum.INTERMEDIATE, AggravationEnum.CHILD, 112453023);
        PatientNode patientTestNode1 = new PatientNode(2, patientTest1, 112453023);
        date.set(2004, 7, 23);
        Patient patientTest2= new Patient("Constanza", date, "HOLA",3, StateEnum.GRAVE, AggravationEnum.NONE, 202453025);
